...
<head>
    ...
    <title>Blood Donation Camp Admin Dashboard</title>
    <!-- Favicon icon -->
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="{{route('home')}}"  class="brand-logo">
				<img class="logo-abbr" src="{{asset('frontend/images/blood-drop.png')}}" alt="">
                <img class="brand-title" src="{{asset('frontend/images/bloodhost.png')}}" alt="">
            </a>
							...
							<li class="nav-item dropdown notification_dropdown">
                                ...
                                <div class="dropdown-menu rounded dropdown-menu-right">
                                    <div id="DZ_W_Notification1" class="widget-media dz-scroll p-3 height380">
										<ul class="timeline">
											@forelse (App\Models\Contact::where('status', 0)->get() as $message)
											<li>
											...
											@empty
											<h4 class="text-danger">You have no notifiactions</h4>
											@endforelse
										</ul>
									</div>
                                    <a class="all-notification" href="{{route('message')}}">See all notifications <i class="ti-arrow-right"></i></a>
                                </div>
                            </li>
				...
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{route('nav.menu')}}">Add Menu</a></li>
                            <li><a href="{{route('banner.info')}}">Edit Banner Info</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-internet"></i>
							<span class="nav-text">Blood</span>
						</a>
                        <ul aria-expanded="false">
                            <li><a href="{{route('blood')}}">Add Blood group</a></li>
                            <li><a href="{{route('donor.list')}}">All Donor List</a></li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{route('about.edit')}}">Edit About Info</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{route('counter')}}">Edit Achievement</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{route('review')}}">Add Review</a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
						<i class="flaticon-381-heart"></i>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{route('footer')}}">Edit Footer Info</a></li>
                            <li><a href="{{route('footer.icon')}}">Footer Icon & Image</a></li>
                            <li><a href="{{route('edit.term')}}">Edit Terms of use</a></li>
                            <li><a href="{{route('edit.policy')}}">Edit Terms of use</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
						<i class="flaticon-381-network"></i>
						...
						<ul aria-expanded="false">
							<li><a href="{{route('message')}}">Message List</a></li>
						</ul>
					</li>
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
						<i class="flaticon-381-notepad"></i>
						...
						<ul aria-expanded="false">
							<li><a href="{{route('donation')}}">Donation List</a></li>
						</ul>
					</li>
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
						<i class="flaticon-381-networking"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{route('role')}}">Add Permission</a></li>
                        </ul>
                    </li>
                </ul>
			</div>
