        ...
        <div class="cs-invoice_head cs-type1 cs-mb25">
          ...
          <div class="cs-invoice_right cs-text_left">
            ...
            <img style="max-width: 100px;"
                    src="{{asset('upload/logo')}}/{{$logo->logo}}" alt="">
            @endforeach
          </div>
        </div>
              ...
              <table>
                <thead>
                  <tr>
                    ...
                    <th class="cs-width_2 cs-semi_bold cs-primary_color cs-focus_bg">Last Donate</th>
                    <th class="cs-width_2 cs-semi_bold cs-primary_color cs-focus_bg">Image</th>
                    <th class="cs-width_4 cs-semi_bold cs-primary_color cs-focus_bg cs-text_center">Blood Group</th>
                   
                  </tr>
                </thead>
                <tbody>
                    @foreach ($data as $sl=>$donor)
                    <tr>
                        <td class="cs-width_1">{{$sl+1}}</td>
                        <td class="cs-width_3">{{$donor->rel_to_donor->name}}</td>
                        <td class="cs-width_2">{{$donor->donate_date}}</td>
                         <td class="cs-width_2">
                             @if ($donor->rel_to_donor->donor_img == null)
                                    <img src="{{asset('frontend/images/donor-img-null .jpg')}}" class="img-fluid rounded-start" alt="...">
                                    @else
                                    <img width="60" src="{{asset('upload/donor')}}/{{$donor->rel_to_donor->donor_img}}" class="img-fluid rounded-start" alt="...">
                                    @endif
                             </td>
                        <td class="cs-width_4 cs-text_center">{{$donor->rel_to_donor->rel_to_blood->blood_group}}</td>
                    </tr>
                    @endforeach
                </tbody>
